...
我以迭代开发的思路做这个项目，初中六册完成即为《悟数学》1.0版本发布，高中理工面向完成为2.0版本发布。之后视情况可能还会有其他高中部分的其他面向以及线性代数、实分析、复分析、泛函分析、概率论、微分几何、近世代数、代数拓扑等课程的入门教材。
...
这些内容是和《悟数学》衔接的大学本科低年级用教材。完成《悟数学》中学数学内容的读者可以继续阅读，与高等数学知识直接衔接。

- 《[平直代数](./悟数学/平直空间初论.pdf)》（[导言](./悟数学/《平直代数》导言.md)）
- 《数学分析》
- 《概率论》
- 《抽象代数》